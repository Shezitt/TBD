...
$resultado = $conn->query("SELECT fecha, executedSQL, reverseSQL FROM Auditoria_Promocion ORDER BY idAuditoria DESC");
...
<head>
    <meta charset="UTF-8">
    <title>Auditoría Promoción</title>
