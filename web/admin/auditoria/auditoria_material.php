...
$resultado = $conn->query("SELECT fecha, executedSQL, reverseSQL FROM Auditoria_Material ORDER BY idAuditoria DESC");
...
<head>
    <meta charset="UTF-8">
    <title>Auditoría Material</title>
