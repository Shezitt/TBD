...
$resultado = $conn->query("SELECT fecha, executedSQL, reverseSQL FROM Auditoria_Punto_Reciclaje ORDER BY idAuditoria DESC");
...
<head>
    <meta charset="UTF-8">
    <title>Auditoría Punto de Reciclaje</title>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>AUDITORÍA DE PUNTO DE RECICLAJE</h1>
        </div>
