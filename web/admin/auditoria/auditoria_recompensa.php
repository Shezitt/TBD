...
$resultado = $conn->query("SELECT fecha, executedSQL, reverseSQL FROM Auditoria_Recompensa ORDER BY idAuditoria DESC");
...
<head>
    <meta charset="UTF-8">
    <title>Auditoría Recompensa</title>
