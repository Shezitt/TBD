...
$resultado = $conn->query("SELECT fecha, executedSQL, reverseSQL FROM Auditoria_Catalogo ORDER BY idAuditoria DESC");
...
<head>
    <meta charset="UTF-8">
    <title>Auditoría Catálogo</title>
