...
// Obtener registros de auditoría para Registro_Reciclaje
$resultado = $conn->query("SELECT fecha, executedSQL, reverseSQL FROM Auditoria_Registro_Reciclaje ORDER BY idAuditoria DESC");
...
<head>
    <meta charset="UTF-8">
    <title>Auditoría Registro de Reciclaje</title>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>AUDITORÍA DE REGISTRO DE RECICLAJE</h1>
        </div>
