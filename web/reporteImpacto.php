...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const materiales = [], reciclado = [], co2 = [], agua = [], energia = [];
...
new Chart(document.getElementById("graficoAgua"), {
  ...
  options: {
    plugins: {
      title: { display: true, text: '💧 Agua Ahorrada' },
      legend: { display: false }
    }
  }
});
...
new Chart(document.getElementById("graficoEnergia"), {
  ...
  options: {
    cutout: '65%',
    plugins: {
      title: { display: true, text: '⚡ Energía Ahorrada' },
      legend: { display: false }
    }
  }
});
...
const matUsu = [], recicladoUsu = [], co2Usu = [], aguaUsu = [], energiaUsu = [];
